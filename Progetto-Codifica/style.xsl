...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/1999/xhtml" xmlns:tei="http://www.tei-c.org/ns/1.0" version="1.0">
   ...
   <xsl:template match="tei:surface[@xml:id='retro1' or @xml:id='retro2' or @xml:id='retro3']/tei:graphic">
      <img id="dimRetro" src="{@url}" />
      <xsl:apply-templates />
   </xsl:template>
   ...
   <xsl:template match="tei:notesStmt[@xml:id='notesStmt1' or @xml:id='notesStmt3']">
      <div class="no">
         <xsl:apply-templates />
      </div>
   </xsl:template>
   ...
   <xsl:template match="tei:div[@xml:id='txtDesc1' or @xml:id='txtDesc2' or @xml:id='txtDesc3']"> <!-- per racchiudere le tre parti di testo in un unico div -->
      <div id="txt">
         <xsl:apply-templates />
      </div>
      <br />
